...
public class ManagedCardRequest {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(mode, authForwardingDefaultTimeoutDecision, nameOnCard, profileId, digitalWallets, threeDSecureAuthConfig, tag, billingAddress, nameOnCardLine2, friendlyName, cardholderMobileNumber);
  }
