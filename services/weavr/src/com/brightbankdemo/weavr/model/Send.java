...
public class Send {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(scheduledTimestamp, cancellationReason, destination, description, source, profileId, creationTimestamp, id, tag, state, challengeExemptionReason, destinationAmount, executionTimestamp);
  }
