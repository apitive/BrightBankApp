...
import com.brightbankdemo.weavrfundstransfer.model.ManagedCardRequest;
...
public interface ManagedCardsService {
  ...
  void managedCardAssign(@Param("idempotency_ref") String idempotency_ref);
  ...
  @Headers({
    ...
    "Accept: ",
    "idempotency-ref: {idempotency_ref}"  })
  void managedCardPhysicalActivate(@Param("id") String id, @Param("idempotency_ref") String idempotency_ref);
  ...
  @Headers({
    ...
    "Accept: ",
    "idempotency-ref: {idempotency_ref}"  })
  void managedCardPhysicalContactlessLimitReset(@Param("id") String id, @Param("idempotency_ref") String idempotency_ref);
  ...
  @Headers({
    ...
    "Accept: ",
    "idempotency-ref: {idempotency_ref}"  })
  void managedCardPhysicalReplaceDamaged(@Param("id") String id, @Param("idempotency_ref") String idempotency_ref);
  ...
  @Headers({
    ...
    "Accept: ",
    "idempotency-ref: {idempotency_ref}"  })
  void managedCardPhysicalReplaceLostOrStolen(@Param("id") String id, @Param("idempotency_ref") String idempotency_ref);
   ...
   * Upgrades the virtual card identified by the &#x60;id&#x60; path parameter to physical.  Before cards can be upgraded, a physical card programme must be set up and the card profile configuration updated accordingly. 
    * @param id  (required)
    * @param idempotency_ref A unique call reference generated by the caller that, taking into consideration the payload as well as the operation itself, helps avoid duplicate operations. Idempotency reference uniqueness is maintained for at least 24 hours. (optional)
   */
  ...
  @Headers({
    ...
    "Accept: ",
    "idempotency-ref: {idempotency_ref}"  })
  void managedCardPhysicalUpgrade(@Param("id") String id, @Param("idempotency_ref") String idempotency_ref);
  ...
  @Headers({
    ...
    "Accept: ",
    "idempotency-ref: {idempotency_ref}"  })
  void managedCardSpendRulesCreate(@Param("id") String id, @Param("idempotency_ref") String idempotency_ref);
  ...
  @Headers({
    ...
    "Accept: ",
    "idempotency-ref: {idempotency_ref}"  })
  void managedCardSpendRulesUpdate(@Param("id") String id, @Param("idempotency_ref") String idempotency_ref);
   ...
   */
  @RequestLine("GET /managed_cards/{id}/statement?offset={offset}&limit={limit}&orderByTimestamp={orderByTimestamp}&fromTimestamp={fromTimestamp}&toTimestamp={toTimestamp}&singleEntryPerTransaction={singleEntryPerTransaction}")
  @Headers({
    "Accept: ",
    "accept: {accept}"  })
  void managedCardStatement(@Param("id") String id, @Param("accept") String accept, @Param("offset") Integer offset, @Param("limit") Integer limit, @Param("orderByTimestamp") String orderByTimestamp, @Param("fromTimestamp") Long fromTimestamp, @Param("toTimestamp") Long toTimestamp, @Param("singleEntryPerTransaction") Boolean singleEntryPerTransaction);
  ...
  @Headers({
    ...
    "Accept: ",
    "idempotency-ref: {idempotency_ref}"  })
  void managedCardUpdate(@Param("id") String id, @Param("idempotency_ref") String idempotency_ref);
